...
language:
- en
pretty_name: Clawpatch Gemma map v0
size_categories:
- n<1K
---

# Clawpatch Gemma map v0
...
- Excluded scope: review, revalidate, and fix provider calls
...
```json
{
  ...
  "metadata": {"operation": "map", "validationStatus": "schema-valid-operation-valid"}
}
```
